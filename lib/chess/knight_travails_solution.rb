#Brilliant donaldali (from github) solution!!
...
#puts possible_moves([1,1]).inspect
#puts valid_moves([1,1]).inspect
#puts copy([1,1])
#puts make_position_path([1,1],[0,3]).inspect

# knight_moves([0,0],[1,2]) # -> [[0,0],[1,2]]
# knight_moves([0,0],[3,3]) # -> [[0,0],[1,2],[3,3]]
 knight_moves([1,1],[2,2]) # -> [[3,3],[1,2],[0,0]]
