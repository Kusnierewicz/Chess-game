module Chess
  class Board
    ...
    def print_board
      ...
      puts "  -------------------------"
      puts "7 |#{@grid[0][1].value}|#{@grid[1][1].value}|#{@grid[2][1].value}|#{@grid[3][1].value}|#{@grid[4][1].value}|#{@grid[5][1].value}|#{@grid[6][1].value}|#{@grid[7][1].value}|"
      puts "  -------------------------"
      puts "6 |#{@grid[0][2].value}|#{@grid[1][2].value}|#{@grid[2][2].value}|#{@grid[3][2].value}|#{@grid[4][2].value}|#{@grid[5][2].value}|#{@grid[6][2].value}|#{@grid[7][2].value}|"
      puts "  -------------------------"
      ...
      puts "  -------------------------"
      puts "2 |#{@grid[0][6].value}|#{@grid[1][6].value}|#{@grid[2][6].value}|#{@grid[3][6].value}|#{@grid[4][6].value}|#{@grid[5][6].value}|#{@grid[6][6].value}|#{@grid[7][6].value}|"
      puts "  -------------------------"
      puts "1 |#{@grid[0][7].value}|#{@grid[1][7].value}|#{@grid[2][7].value}|#{@grid[3][7].value}|#{@grid[4][7].value}|#{@grid[5][7].value}|#{@grid[6][7].value}|#{@grid[7][7].value}|"
      puts "  -------------------------"
    end
